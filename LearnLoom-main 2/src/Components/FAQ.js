  ...
  return (
    <div className="faq-section">
      ...
      <div className="faq-right">
        <div className={`faq-item ${showAnswer.question1 ? "show" : ""}`} onClick={() => toggleAnswer("question1")}>
        ...
        <div className={`faq-item ${showAnswer.question2 ? "show" : ""}`} onClick={() => toggleAnswer("question2")}>
        ...
        <div className={`faq-item ${showAnswer.question3 ? "show" : ""}`} onClick={() => toggleAnswer("question3")}>
        ...
        <div className={`faq-item ${showAnswer.question4 ? "show" : ""}`} onClick={() => toggleAnswer("question4")}>
